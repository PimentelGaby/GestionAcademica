    ...
    if (this.idEstudiante && this.idEstudiante > 0) {
      ...
      this.estudianteService.obtenerEstudiantePorID(this.idEstudiante).subscribe({
        next: (temp) => {
          ...
          this.form.controls['nombresEstudiante'].setValue(this.formEstudiante.nombreEstudiante);
          this.form.controls['apellidosEstudiante'].setValue(this.formEstudiante.apellidoEstudiante);
